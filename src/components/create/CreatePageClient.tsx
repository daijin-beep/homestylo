...
import type { RoomAnalysis, RoomType, Scheme, StyleType } from "@/lib/types";
...
const PRESET_STYLE_VALUES = new Set<StyleType>([
  "midcentury",
  "cream_french",
  "wabi_sabi",
  "song",
...
export function CreatePageClient() {
  ...
  useEffect(() => {
    ...
    if (!presetStyle || !PRESET_STYLE_VALUES.has(presetStyle as StyleType)) {
      return;
    }
