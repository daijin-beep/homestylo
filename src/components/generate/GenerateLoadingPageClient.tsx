...
function GenerateLoadingPageContent() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[radial-gradient(circle_at_top,#fffaf4_0%,#f5ede1_52%,#efe4d6_100%)] px-4">
      <section className="w-full max-w-xl space-y-8 rounded-[32px] border border-[#e3d4c3] bg-white/70 px-6 py-10 text-center shadow-sm backdrop-blur md:px-10">
        <div className="space-y-2">
          <p className="text-xs uppercase tracking-[0.28em] text-[#8B5A37]/70">HomeStylo</p>
        ...
        <p className="text-sm leading-6 text-muted-foreground">
          我们会依次完成空间分析、推荐计算和效果图生成，页面会自动跳转到最新结果。
        </p>
...
export function GenerateLoadingPageClient() {
  return (
    <Suspense
      fallback={
